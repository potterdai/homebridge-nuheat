...
module.exports = class NuHeatThermostat {
    ...
    async setTargetTemperature(value, callback) {
        ...
        await this.thermostat.setTargetTemperature(heatSetPoint);
        await this.updateAccessory();
        callback(null);
    }

    async updateAccessory() {
        await this.thermostat.fetchData();
        this.updateValues();
    }

    updateValues() {
        // current temperature
        var currentTemperature = this.toHBTemperature(this.thermostat.temperature);
        ...
        var setPointTemperature = this.toHBTemperature(this.thermostat.targetTemperature);
        var minTemperature = this.toHBTemperature(this.thermostat.minTemperature);
        var maxTemperature = this.toHBTemperature(this.thermostat.maxTemperature);
        if (setPointTemperature < minTemperature) setPointTemperature = minTemperature;
        if (setPointTemperature > maxTemperature) setPointTemperature = maxTemperature;
        ...
        // system switch mode
        var TargetHeatingCooling = this.toHomeBridgeisHeatingCoolingSystem(this.thermostat.operatingMode);
